...
DEFAULT_PYAITALK_API_URL = "http://127.0.0.1:8081"
...
async def synthesize_speech_pyaitalk(
    ...
    return merge_wav_chunks(wav_chunks)
    ...
    for chunk in wav_chunks:
        with wave.open(io.BytesIO(chunk), "rb") as wav_reader:
            ...
            if channels is None:
                ...
                raise RuntimeError("Engine returned WAV chunks with mismatched audio format")
